    ...
    <CardContent>
      <form>
        <Grid container spacing={7}>
          ...
          <Grid item xs={12}>
            <Button style={{width:"25%",height:"50px"}} variant='contained' sx={{ marginRight: 3.5 }}>
              Save Changes
            </Button>
            <Button style={{width:"25%",height:"50px"}} type='reset' variant='outlined' color='secondary' onClick={() => setDate(null)}>
              Reset
            </Button>
          </Grid>
        </Grid>
